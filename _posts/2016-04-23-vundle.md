---
layout: post
title: "vim插件安装神器vundle"
subtitle: "\"这是一个神器的vim插件，简易在安装任何插件前，先安装这个\""
author: mgsweet
date: 2016-04-23 15:59:35 +0800
categories: vim
tag: vim
---
...
Vundle 
---
首先给出这个神器的github：https://github.com/VundleVim/Vundle.vim

上面有英文版的使用教程([接近翻译的中文版教程](http://www.it165.net/os/html/201407/8798.html))

*最近在学习搞自己的博客的路上看了不少优秀的博客，在一个自制博客里发现一篇关于vim不错的文章—[Git时代的VIM不完全使用教程](http://beiyuu.com/git-vim-tutorial/)，然后找到了vundle，一直懒得搞自己的vim，不过由于最近经常要用到命令行，所以既然有新发现（虽然后来发现原来很多人都知哈哈），就试着折腾一下，上面那篇文章的版本是旧的，新的版本用pluginInstall安装插件*

.vimrc文件配置
---
另外一个发现就是beiyuu的.vimrc文件配置。



[实时更新的.vimrc请点击我](https://github.com/beiyuu/vimfiles/blob/master/_vimrc)
```
